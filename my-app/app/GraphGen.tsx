...
const GraphGen: React.FC = () => {
    ...
    return (
      <div className="p-8 shadow-lg shadow-slate-400 bg-black-custom rounded-md">
        ...
        <button className="py-2 px-6 rounded-md bg-purple-custom-saturated text-white-custom shadow-md shadow-purple-700"  onClick={handleButtonClick}>Load Graph</button>
