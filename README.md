...
5. Get your jwt token to access your warframe.market account with their api. To do this:
...
The first button, that will start out looking like "Stats Reader Status: Not running" starts to gather 7 days of data on every item on warframe.market (slowly, no more than 3 api calls a second as to not overload their systems and to comply with their TOS). This data is saved to allItemData.csv and takes about 50 minutes to complete. Thus, I would only recommend clicking this button once a day at most since you don't need this data to be updating constantly. 
